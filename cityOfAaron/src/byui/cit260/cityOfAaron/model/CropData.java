...
public class CropData implements Serializable {
    ...
    public int hashCode() {
        ...
        hash = 71 * hash + this.cropYield;
        hash = 71 * hash + this.wheatInStore;
        hash = 71 * hash + this.numberWhoDied;
        hash = 71 * hash + this.newPeople;
        hash = 71 * hash + this.harvest;
        hash = 71 * hash + this.harvestAfterOffering;
        hash = 71 * hash + this.offering;
        hash = 71 * hash + this.offeringBushels;
        hash = 71 * hash + this.peopleFed;
        hash = 71 * hash + this.acresPlanted;
        hash = 71 * hash + this.numStarved;
        hash = 71 * hash + this.eatenByRats;
        hash = 71 * hash + this.wheatForPeople;
        return hash;
    }
